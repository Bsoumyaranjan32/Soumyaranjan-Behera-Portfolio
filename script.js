...
// Note: This uses `window.open(..., '_blank')` to open a new tab.
// Consider using an <a> with `rel="noopener noreferrer"` for improved security.
if (resumeBtn) {
    resumeBtn.addEventListener('click', () => {
        window.open("./assets/Soumyaranjan_Behera Resume.pdf", "_blank");
    });
}
